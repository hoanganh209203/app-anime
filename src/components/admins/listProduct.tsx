...
const ListProduct = ({productsData}:Props) => {
                 ...
                 {productsData.map((item) => (
                     <div className="group relative">
                         <div className="relative aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                             <img src={item.images.path} alt="Front of men&#039;s Basic Tee in black." className="h-full w-full object-cover object-center lg:h-full lg:w-full
                         ...
                         <div className="mt-4 flex justify-center">
                             <div className="text-center">
                                 ...
                                 <p className="mt-1 text-sm text-gray-500">Lượt xem:{formatNumber(item.price)}</p>
                             </div>
