...
<div className="font-[sans-serif] text-[#333] mt-4 p-4 relative">
  <div className="max-w-md w-full mx-auto relative z-50">
    <div className="text-center mb-8">
      <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" className="w-48 inline-block" />
      </a>
    </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="relative flex items-center">
              ...
              className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter name" />
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter email" />
          ...
          <div>
            ...
            <div className="relative flex items-center">
              ...
              className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Enter password" />
          ...
          <div>
            <label className="text-sm mb-2 block">ConfirmPassword</label>
            <div className="relative flex items-center">
              <input 
