...
const Headers = () => {
  ...
  const userInfo = userToken ? JSON.parse(userToken) : null;
  const userName = userInfo && userInfo.user && userInfo.user.name;
//   const userRole = userInfo && userInfo.user && userInfo.user.role;
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {userName && (
                ...
                // <p>Welcome, {userName}! Your role is: {userRole}</p>
      )}
            </> : <>
            
            <div className="flex items-center gap-2.5">
              <button onClick={() => { setState({ type: 'login' }) }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={18}
                  height={18}
            ...
            <div className="flex items-center gap-2.5">
              <button onClick={() => { setState({ type: 'register' }) }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={18}
                  height={18}
